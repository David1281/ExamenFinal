...
export class FSMDl extends FSM{
    ...
    buildTransitionTable(){
        ...
        this.addTransition(StatesDL.Entero, StatesDL.DecimalInitial, AlphabetDL.dot);
        this.addTransitionMultipleInputs(StatesDL.DecimalInitial, StatesDL.DecimalFinal, [AlphabetDL._0, AlphabetDL._1, AlphabetDL._2, AlphabetDL._3, AlphabetDL._4, AlphabetDL._5, AlphabetDL._6, AlphabetDL._7, AlphabetDL._8, AlphabetDL._9]);
        // Slash
